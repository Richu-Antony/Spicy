// List of all Colors used in the app.
import 'package:flutter/material.dart';

// Realtime Colors link for selected colors: https://realtimecolors.com/?colors=1c2541-ffffff-4dff29-e9f4ff-76a6da
// Realtime Colors link for selected colors: https://realtimecolors.com/?colors=fcfdfe-010409-00ff59-01242b-05b8bb

class AppColors {
  // Light mode Main app colors
  static const lightColorPrimary = Color(0xffffffff);
  static const lightColorSecondary = Color(0xffe9f4ff);
  ...
  static const lightColorTrinaryButton = Color(0xffffefc2);
  static const lightColorAccent = Color(0xff76a6da);
  ...
  static const darkColorSecondaryButtonVarient = Color(0xff9d34da);
  static const darkColorTrinaryButton = Color(0xff00ff59);
  static const darkColorTrinaryButtonVarient = Color(0xffffc857);
  static const darkColorAccent = Color(0xff05b8bb);

  // Onboarding Screen Colors
  static const lightColorOnboardingScreen1 = Color(0xffffffff);
  static const lightColorOnboardingScreen2 = Color(0xffe9f4ff);
  static const lightColorOnboardingScreen3 = Color(0xffdcd1d2);
